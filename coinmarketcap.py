...
if __name__ == '__main__':
	try:
		...
		parser.add_argument('--port', nargs='?', const=9101, help='The TCP port to listen on', default=9101) # Might need to change the port binding
		parser.add_argument('--addr', nargs='?', const='127.0.0.1', help='The interface to bind to', default='127.0.0.1') # Need to chnage address binding to local docker address
